...
<?php include'ticker.php'; ?>
  ...
  <div id="demo" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="carousel-item">
        <img src="image\blood-cells.png" alt="image\blood-cells.png" width="100%" height="500">
      </div>
    </div>
...
<br>
        <h1 style="text-align:center;font-size:45px;">Welcome to Hemacare</h1>
<br>
        <div class="row">
